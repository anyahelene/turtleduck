 ...
 * questions.
 */
package turtleduck.shell.control;
 ...
 * @since 9
 */
public class TShellLocalExecutionControl extends DirectExecutionControl {
     ...
     */
    public TShellLocalExecutionControl(LoaderDelegate loaderDelegate) {
     ...
     */
    public TShellLocalExecutionControl() {
    }

    @Override
    protected String invoke(Method doitMethod) throws Exception {
    	System.out.println("invoking: " + doitMethod.toGenericString());
    	if(lastResult != null)
    		throw new IllegalStateException("lastResult not collected");
