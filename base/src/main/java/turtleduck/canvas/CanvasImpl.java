...
public class CanvasImpl<S extends Screen> implements Canvas {
    ...
    public Particles particles() {
        Matrix3x2d m = matrix();
        Matrix4f m3d = new Matrix4f((float) m.m00, (float) m.m01, 0f, 0f, //
                (float) m.m10, (float) m.m11, 0f, 0f, //
                0f, 0f, 1f, 0f, //
                (float) m.m20, (float) m.m21, 0f, 1f);
        Particles particles = pathWriterFactory.apply(false).addParticles(m3d);
        return particles;
    }
}
