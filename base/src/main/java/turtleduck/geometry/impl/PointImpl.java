 ...
 *
 */
public class PointImpl extends Vector3d implements IPoint3, Direction, DirectionVector {
    ...
    public Point add(DirectionVector dir, double distance) {
        ...
        return new PointImpl(x + dir.dirX() * distance, y + dir.dirY() * distance, z + dir.dirZ() * distance);
    ...
    @Override
    public boolean like(PositionVector other) {
        // TODO Auto-generated method stub
        return false;
    }
    ...
    public Point transform(Point point) {
        ...
        return new PointImpl(x * Math.cos(r) - y * Math.sin(r), x * Math.sin(r) + y * Math.cos(r), z);
    }
