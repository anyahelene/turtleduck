...
public class EditorServer implements EditorService {
    ...
    private Async<Dict> doEval(EditSession current, String contents, Async<Void> writePromise, EditLanguage lang) {
        ...
        return current.lang.shell.eval(contents, current.id, opts).then(msg -> {
             ...
             * if (lang.console != null) {
             * lang.console.println("INTERNAL ERROR: " + ename + (evalue != null ? (" : " +
             * evalue) : ""), Colors.RED);
    ...
    static class Shell {
        ...
        public void processResult(Dict msg, boolean b, LanguageConsole console) {
        }

        public Async<Dict> eval(String contents, int id, Dict opts) {
            return null;
        }
        ...
        public void printError(String string, Dict msg, LanguageConsole console) {
        }
    }

    static class LanguageConsole {
        ...
        public LanguageConsole diagHandler(BiConsumer<Dict, Location> object) {
            return null;
        }
