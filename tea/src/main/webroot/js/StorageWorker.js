...
(async () => {
    ...
    portal.set('fsWorker', {
        ...
        writeFile: async (filepath, data, opts) =>
            pfs.writeFile(filepath, data, opts), // (mode, encoding) -> void
        ...
        rename: async (oldFilepath, newFilepath, opts) =>
            pfs.rename(oldFilepath, newFilepath, opts), // -> void
        stat: async (filepath, opts) => pfs.stat(filepath, opts), // -> Stats
        lstat: async (filepath, opts) => pfs.lstat(filepath, opts), // -> Stats
        symlink: async (target, filepath, opts) =>
            pfs.symlink(target, filepath, opts), // -> void
